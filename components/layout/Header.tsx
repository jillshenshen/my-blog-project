...
export async function Header() {
  ...
  return (
    <header className="bg-background">
      {/* Logo block — 緊湊留白 */}
      <div className="mx-auto max-w-6xl px-4 pt-10 pb-6 text-center sm:px-6 sm:pt-16 sm:pb-12">
        <Link
          href="/"
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center gap-3 border-y border-[var(--color-border)] py-3 sm:flex-row sm:justify-between sm:gap-6">
